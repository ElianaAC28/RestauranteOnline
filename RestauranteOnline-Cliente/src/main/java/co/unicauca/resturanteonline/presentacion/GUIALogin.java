 ...
 * @author dania
 */
public class GUIALogin extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIALogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
